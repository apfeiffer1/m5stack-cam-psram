...
[English](https://github.com/m5stack/m5stack-cam-psram/blob/FishEye/README.md) | [中文](https://github.com/m5stack/m5stack-cam-psram/blob/FishEye/README_zh_CN.md) | 日本語

## ファームウェア概要

[esp32-camera](https://github.com/espressif/esp32-camera.git)をベースにしたこのリポジトリは、PSRAMを内蔵した[M5CameraF](https://docs.m5stack.com/#/ja/unit/m5camera_f)向けのファームウェアをホストします。さらに、キャプチャされたフレームデータをより一般的な`BMP`および`JPEG`形式に変換するためのツールも提供します。
