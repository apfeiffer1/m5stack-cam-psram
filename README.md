...
This repository based in [esp32-camera](https://github.com/espressif/esp32-camera.git) is the firmware for [M5CameraF](https://docs.m5stack.com/#/en/unit/m5camera_f) built in PSRAM chip. Additionally it provides a few tools, which allow converting the captured frame data to the more common BMP and JPEG formats.
