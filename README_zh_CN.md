...
[English](https://github.com/m5stack/m5stack-cam-psram/blob/FishEye/README.md) | 中文 | [日本語](https://github.com/m5stack/m5stack-cam-psram/blob/FishEye/README_ja.md)

## 固件说明

这个基于[esp32-camera](https://github.com/espressif/esp32-camera.git)的存储库是内置PSRAM芯片[M5CameraF](https://docs.m5stack.com/#/zh_CN/unit/m5camera_f)的固件。此外，它还提供了一些工具，可以将捕获的帧数据转换为更常见的BMP和JPEG格式。
